...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Имя автора книги - " + hyperion.getAuthorName().getFirstName() + " " + hyperion.getAuthorName().getSecondNameName() + " " + "; Название книги - " + hyperion.getBookName() + "; Год публикации - " + hyperion.getPublishingYear());
        ...
        System.out.println("Имя автора книги - " + fahrenheit451.getAuthorName().getFirstName() + " " + fahrenheit451.getAuthorName().getSecondNameName() + " " + "; Название книги - " + fahrenheit451.getBookName() + "; Год публикации - " + fahrenheit451.getPublishingYear());
        printSeparator();
